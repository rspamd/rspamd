...
<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
  ...
  test("dispatches a compressed SVGZ and injects the smuggled HTML", function()
    ...
    assert_equal(#specific.payloads, 1)
    assert_equal(specific.payloads[1].type, 'text/html')
    assert_equal(specific.payloads[1].content, html_payload)
    assert_equal(specific.payloads[1].truncated, false)
