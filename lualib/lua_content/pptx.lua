...
-- PPTX content processor: a thin format binding over the shared OOXML
...
exports.extract = function(package, options, state)
  return ooxml.extract(package, options, state, 'pptx')
end

exports.process = function(input, mpart, task)
  return ooxml.process_document(input, mpart, task, 'pptx')
end
