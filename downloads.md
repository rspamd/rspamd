...
<p><a class="btn btn-primary btn-lg" href="/downloads/rspamd-0.9.2.tar.xz">Download rspamd-0.9.2</a></p>
...
If you want to check the integrity of your source archive downloaded, then you could use the following [GPG signature](/downloads/rspamd-0.9.2.tar.xz.asc).
