...
<p><a class="btn btn-primary btn-lg" href="/downloads/rspamd-1.0.7.tar.xz">Download rspamd-1.0.7</a></p>
...
If you want to check the integrity of your source archive downloaded, then you could use the following [GPG signature](/downloads/rspamd-1.0.7.tar.xz.asc).
