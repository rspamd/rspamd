...
enum rspamd_task_stage {
	...
	RSPAMD_TASK_STAGE_AUTOLEARN_PRE = (1u << 11u),
	RSPAMD_TASK_STAGE_AUTOLEARN = (1u << 12u),
	RSPAMD_TASK_STAGE_AUTOLEARN_POST = (1u << 13u),
	RSPAMD_TASK_STAGE_LEARN_PRE = (1u << 14u),
	RSPAMD_TASK_STAGE_LEARN = (1u << 15u),
	RSPAMD_TASK_STAGE_LEARN_POST = (1u << 16u),
	RSPAMD_TASK_STAGE_COMPOSITES_POST = (1u << 17u),
	RSPAMD_TASK_STAGE_IDEMPOTENT = (1u << 18u),
	RSPAMD_TASK_STAGE_DONE = (1u << 19u),
	RSPAMD_TASK_STAGE_REPLIED = (1u << 20u),
};
...
#define RSPAMD_TASK_PROCESS_ALL (RSPAMD_TASK_STAGE_CONNECT |          \
								 ...
								 RSPAMD_TASK_STAGE_AUTOLEARN_PRE |    \
								 RSPAMD_TASK_STAGE_AUTOLEARN |        \
								 RSPAMD_TASK_STAGE_AUTOLEARN_POST |   \
