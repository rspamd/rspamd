...
Rspamd as a spamfiltering system or as a project spelled with a capital `R`, followed by a lower-case `spamd`, but when referring to the process or aplication it is not capitalized.
